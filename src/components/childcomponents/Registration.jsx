...
export default function Registration() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // Success → usually redirect to login or auto-login & go to dashboard
      // For most Laravel apps → redirect to /login after registration
      navigate('/login', { replace: true });
      // If your Laravel auto-logs in the user → navigate('/dashboard', { replace: true });
    } catch (err) {
